  ...
  return (
    ...
    <section className='h-[800px] bg-[#DEFCF9] bg-no-repeat bg-cover bg-center py-24 '> 
      <div className="container mx-auto flex justify-around h-full">
        {/* text  */}
        <div className='flex flex-col justify-center z-10 text-[#b49831]'>
          <div className='font-semibold flex items-center uppercase'>
            <div className='w-10 h-[2px] bg-[#3273eb] mr-3'></div>New Trend
          </div>
          <h1 className='text-[70px] leading-[1.1] font-light mb-4 '>LOOK FAMOUS<br/>
        ...
        {/* image  */}
        <div className='absolute z-1 md:static h-full'>
